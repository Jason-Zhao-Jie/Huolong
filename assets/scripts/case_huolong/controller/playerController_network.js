...
export default class PlayerController_Network extends IPlayerController{
    constructor(controller){
        super(controller)
    }

    getType(){
        return CONSTANTS.PLAYERTYPE.NETWORK
    }
    ...
    getMinUsedMain(){
        let used = {[self]:this.roundData.playerData.getData(self, used, main),
